  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: dark gray;">
    <div class="dropdown">
   	<a href="./" class="brand-link">
     <img src="LOGO.JPG" alt="" class="brand-image img-circle elevation-3 style="opacity: .50;">
      <h3 class="text-center p-0 m-0" style="font-weight: bold; color: white;"><b>ICCT COLLEGES</b></h3>
    ...
    <div class="sidebar">
      <nav class="mt-2">
      <h4 style="font-weight: bold; color: black; font-size: 60px;"></h4>
